...
def report_profile_attack(username, proxy):
    ...
    report_form = {
        ...
        "Field241164302734019_iso2_country_code": "US",
        "Field241164302734019": "United States",
    ...
    print_success("Reported successfully!")
...
def main():
    while True:
        print("Select the type of attack to report:")
        print("1. Report Profile Attack")
        print("2. Report Video Attack")
        print("3. Exit")
        ...
        if choice == "1":
            ...
            proxy = input("Enter the proxy (optional): ")
            report_profile_attack(username, proxy)
        elif choice == "2":
            video_url = input("Enter the Instagram video URL to report: ")
            proxy = input("Enter the proxy (optional): ")
